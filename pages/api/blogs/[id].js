...
export default function handler(req, res) {
  ...
  let blogs = [
    {
      ...
      comment: [
        ...
        { id: 2, by: 'eyob', comment: 'I cannot thank you enough for your understanding and support through some difficult times. It is refreshing to work with someone who provides the utmost in professionalism and kindness.' },
        { id: 3, by: 'amanuel', comment: 'Team of professionals have helped us to improve many aspects of our life, social life included. The personal assistant works hard, we do not need to follow her around, she knows what to do.' },
      ],
      blogMeta: {
        author: 'Ray LeBlond',
        seen: 15,
  ...
  res.status(200).json(...blogs.filter((blog) => blog.id == req.query.id));
}
