...
export default function Footer() {
  return (
    <div className="border-t">
      <div className=" max-w-contentWid m-auto flex flex-col pt-6 pb-16 px-4 gap-4">
        <Link href="#">
          <a className="m-auto grid">
            <div className="cursor-pointer flex m-auto text-5xl lg:text-6xl  font-semibold font-commonFont text-accent">
              Shuk-Shukta Blogs
            </div>
          </a>
        </Link>
        <div className=" font-commonFont text-xl ">
